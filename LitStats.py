...
def time_format(ntime):
    ...
    if hours < 10: hours = str.join('',('0',str(hours)))
    if minutes < 10: minutes = str.join('',('0',str(minutes)))
    if seconds < 10: seconds = str.join('',('0',str(seconds)))
    return "{} Days, {}:{}:{}".format(int(days),int(hours),int(minutes),int(seconds))
...
def get_stats(file):
    try:
        ...
        with open(file) as fp:
            ...
            playtime = lines[1] #2
            playtime = time_format(float(playtime))
        ...
        print("Could not read log:", sys.exc_info()[0])
        raise
...
def display(data):
    ...
    print("",
        "\033[90m╭╼\033[97;3;1m Litcube's Universe \033[90m╾╮\033[00m",
        "\033[90m├──────────────────────┴───────────────────────────╼\033[00m",
