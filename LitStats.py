...
def write_stats(scr,width):
    ...
    scr.addnstr(2,16,trade_rank,width-17,curses.color_pair(rank))
    scr.addnstr(2,20,trade_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(3,16,combat_rank,width-17,curses.color_pair(rank))
    scr.addnstr(3,20,combat_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(8,16,argon_rank,width-17,curses.color_pair(rank))
    scr.addnstr(8,20,argon_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(9,16,boron_rank,width-17,curses.color_pair(rank))
    scr.addnstr(9,20,boron_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(10,16,paranid_rank,width-17,curses.color_pair(rank))
    scr.addnstr(10,20,paranid_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(11,16,split_rank,width-17,curses.color_pair(rank))
    scr.addnstr(11,20,split_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(12,16,teladi_rank,width-17,curses.color_pair(rank))
    scr.addnstr(12,20,teladi_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(13,16,terran_rank,width-17,curses.color_pair(rank))
    scr.addnstr(13,20,terran_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(14,16,atf_rank,width-17,curses.color_pair(rank))
    scr.addnstr(14,20,atf_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(15,16,goner_rank,width-17,curses.color_pair(rank))
    scr.addnstr(15,20,goner_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(16,16,yaki_rank,width-17,curses.color_pair(rank))
    scr.addnstr(16,20,yaki_perc+'%',width-21,curses.color_pair(perc))
    ...
    scr.addnstr(17,16,pirates_rank,width-17,curses.color_pair(rank))
    scr.addnstr(17,20,pirates_perc+'%',width-21,curses.color_pair(perc))
